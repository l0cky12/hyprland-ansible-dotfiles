...
- This playbook enables SDDM, creates `/usr/local/bin/start-hyprland`, and creates `/usr/share/wayland-sessions/hyprland.desktop` so Hyprland appears in the session selector and launches through the wrapper.
